...
import pom.infy.test.web.rest.errors.BadRequestAlertException;
import pom.infy.test.web.rest.util.HeaderUtil;
...
public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "billingserviceEmployee";
